...
if(season === 'summer'){
  document.writeln(`
    ...
    <div class="card season-card">
      ...
      <div class="card-body p-3">
        <h5 class="card-title fw-bold fs-4 mb-2 text-white">Summer Season Card ☀️</h5>
 ...
 document.writeln(`
    ...
    <div class="card season-card">
      ...
      <div class="card-body p-3">
        <h5 class="card-title fw-bold fs-4 mb-2 text-white">Winter Season Card ❄️</h5>
   ...
   <div class="rainy season d-flex justify-content-center align-items-center">
    <div class="card season-card">
      ...
      <div class="card-body p-2">
        <h5 class="card-title fw-bold fs-4 mb-2 text-white">Rainy Season Card ⛈️</h5>
 ...
 document.writeln(`
    ...
    <div class="card season-card">
      ...
      <div class="card-body p-3">
        <h5 class="card-title fw-bold fs-4 mb-2 text-white">Spring Season Card 🌸</h5>
 ...
 document.writeln(`
    ...
    <div class="card season-card">
      ...
      <div class="card-body p-3">
        <h5 class="card-title fw-bold fs-4 mb-2 text-white">Autumn Season Card 🍁๋࣭</h5>
